                ...
                <div className="home-pricing">
                    <div className="pricingContainer">
                        <div className="home-container04">
                            ...
                            <h2 className="heading2">Choose the Right Plan for Your Needs</h2>
                            <span className="home-pricing-sub-heading bodyLarge">
                                <span>
                                    <span>
                                        Unlock the full potential of image to 3D reconstruction with
                            ...
                            <div className="freePricingCard home-pricing-card">
                                ...
                                <div className="home-container08">
                                    ...
                                    <div className="home-container10">
                                        ...
                                        <span className="bodySmall">
                                            Limited access to advanced editing tools
                                        </span>
                                    </div>
                                    <div className="home-container11">
                                        <span className="home-text42">✔</span>
                                        <span className="bodySmall">Basic support</span>
                                    </div>
                                </div>
                            ...
                            <div className="basicPricingCard home-pricing-card1">
                                ...
                                <div className="home-container14">
                                    ...
                                    <div className="home-container17">
                                        ...
                                        <span className="bodySmall">Access to all editing tools</span>
                                    </div>
                                    ...
                                    <div className="home-container19">
                                        ...
                                        <span className="bodySmall">Export in multiple formats</span>
                                    </div>
                                </div>
                            ...
                            <div className="proPricingCard home-pricing-card2">
                                ...
                                <div className="home-container22">
                                    ...
                                    <div className="home-container24">
                                        ...
                                        <span className="bodySmall">
                                            Advanced AI-enhanced reconstruction
                                        </span>
                                    </div>
                                    ...
                                    <div className="home-container27">
                                        ...
                                        <span className="bodySmall">Collaboration tools</span>
                                    </div>
                                </div>
                ...
                <div className="home-banner">
                    <div className="bannerContainer home-banner1">
                        ...
                        <span className="home-banner-sub-heading bodySmall">
                            Our cutting-edge technology converts flat images into
                            immersive 3D models, bringing your visuals to life like never
